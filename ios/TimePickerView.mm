...
{
    const auto &oldViewProps = *std::static_pointer_cast<TimePickerViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<TimePickerViewProps const>(props);
